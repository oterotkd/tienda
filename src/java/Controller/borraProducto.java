/*
Este Servlet  recibe la informacio del producto que se debe borrar y  elnvia un mensaje 
 */
package Controller;
...
@WebServlet(name = "borraProducto", urlPatterns = {"/borraProducto"})
